BEGIN;
CREATE TABLE IF NOT EXISTS slack_connections (id uuid PRIMARY KEY, owner_id uuid NOT NULL, team_id varchar(255) NOT NULL, team_name varchar(255) NOT NULL, bot_token varchar(2000) NOT NULL, bot_user_id varchar(255), scopes varchar(255) NOT NULL, created_at timestamptz NOT NULL, UNIQUE(owner_id,team_id));
