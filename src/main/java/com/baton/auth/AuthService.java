...
public class AuthService {
	...
	@Transactional
	public User signup(String email, String rawPassword, String name, String team, String position) {
		if (userRepository.existsByEmail(email)) {
			throw new BusinessException(ErrorCode.AUTH_EMAIL_DUPLICATE, "이미 사용 중인 이메일입니다: " + email);
		}
		User user = User.create(email, passwordEncoder.encode(rawPassword), name, team, position);
